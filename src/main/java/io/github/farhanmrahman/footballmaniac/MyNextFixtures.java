...
public class MyNextFixtures extends AppCompatActivity implements LoaderCallbacks<List<Team>>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_next_fixtures);
        ...
        ListView listView = (ListView) findViewById(R.id.my_next_fixtures_layout);
        listView.setAdapter(itemsAdapter);

        emptyStateView = (ImageView) findViewById(R.id.nothing_mf);
        listView.setEmptyView(emptyStateView);

        noInternetView = (ImageView) findViewById(R.id.no_int_mf);
        ...
        if(networkInfo != null && networkInfo.isConnected()){
            ...
            View loadingIndicator = findViewById(R.id.loading_indicator_mf);
    ...
    public Loader<List<Team>> onCreateLoader(int id, Bundle args) {
        return new MyFutureLoader(this, "http://api.football-data.org/v1/fixtures/?timeFrame=n30", myTeams);
    }
